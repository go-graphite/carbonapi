...
func (m *InfoResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.XFilesFactor != 0 {
		dAtA[i] = 0x25
		i++
		i = encodeFixed32CarbonapiV2Pb(dAtA, i, uint32(math.Float32bits(float32(m.XFilesFactor))))
	}
...
func encodeFixed64CarbonapiV2Pb(dAtA []byte, offset int, v uint64) int {
	dAtA[offset] = uint8(v)
...
func encodeFixed32CarbonapiV2Pb(dAtA []byte, offset int, v uint32) int {
	dAtA[offset] = uint8(v)
	dAtA[offset+1] = uint8(v >> 8)
	dAtA[offset+2] = uint8(v >> 16)
	dAtA[offset+3] = uint8(v >> 24)
