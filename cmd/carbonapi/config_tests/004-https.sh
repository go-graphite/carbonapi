...
# CURL should fail as server runs in tls 1.3 only mode
OUT=$(curl --tlsv1.2 --tls-max 1.2 -kvvI https://127.0.0.1:8082 2>&1)
CURL_STATUS=${?}
...
# CURL should succeed as server both supports tls 1.3
