...
LABEL org.opencontainers.image.source https://github.com/grafana/carbonapi

WORKDIR /go/src/github.com/grafana/carbonapi
...
# See https://github.com/grafana/carbonapi/issues/639#issuecomment-896570456 for detailed information
FROM alpine:latest

RUN apk --no-cache add ca-certificates cairo
WORKDIR /

COPY --from=builder /go/src/github.com/grafana/carbonapi/carbonapi ./usr/bin/carbonapi
